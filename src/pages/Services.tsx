...
export default function Services() {
  // This file now renders the Find Staff page (we keep the filename/route for simplicity)
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (res.ok) {
        // GA: mark as a lead like your Contact form
        // @ts-ignore
    ...
    <main className="bg-white">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <div className="card-hover bg-cream p-6 md:p-8 rounded-2xl text-center">
              ...
              <p className="text-dark-gray mb-4 md:mb-6">Senior leadership and C-suite roles with a confidential, comprehensive search.</p>
            ...
            <div className="card-hover bg-light-cream p-6 md:p-8 rounded-2xl text-center">
              ...
              <p className="text-dark-gray mb-4 md:mb-6">Full-time roles across industries and levels. Our most popular service.</p>
              <ul className="text-sm text-dark-gray space-y-2 mb-5 md:mb-6 text-left inline-block">
            ...
            <div className="card-hover bg-cream p-6 md:p-8 rounded-2xl text-center">
              ...
              <p className="text-dark-gray mb-4 md:mb-6">Temporary & project-based roles with fast turnaround and flexible terms.</p>
              <ul className="text-sm text-dark-gray space-y-2 mb-5 md:mb-6 text-left inline-block">
      ...
      <section id="jobForm" className="py-16 md:py-20 bg-white">
        <div className="container max-w-4xl">
          ...
          <form onSubmit={handleSubmit} className="bg-light-cream p-6 md:p-8 rounded-2xl">
